...
export const InventoryNew = ({ handleOpenModal, handleGetInventories }) => {
    ...
    const handleOnSubmit = async (e) => {
        e.preventDefault();
        const inventory = {
            serial, model, description, image, colour, purchaseDate, price,
            user: {
                _id: user
        ...
        try {
            ...
            Swal.fire({
                ...
                text: 'El inventario se ha creado exitosamente.',
            });
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Hubo un error al crear el inventario. Por favor, inténtelo de nuevo.',
            });
        }
    };
                    ...
                    <div className='row'>
                        ...
                        <div className='col'>
                            <div className="mb-3">
                                ...
                                <input required type="date" value={purchaseDate} name='purchaseDate' className="form-control" onChange={(e) => handleOnChange(e)} />
                            </div>
                        </div>
                        <div className='col'>
                            <div className="mb-3">
